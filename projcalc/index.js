...
const ClaCulator = async () => {
    ...
    if (Input.operations === "+") {
        ...
        console.log(chalk.bgBlue(`Result is: ${result}`));
    }
    ...
    else if (Input.operations === "mod") {
        const result = exponent(Input.Num1, Input.Num2);
        console.log(chalk.bgBlue(`Result is: ${result}`));
    }
    else if (Input.operations === "/") {
        const result = modulo(Input.Num1, Input.Num2);
        console.log(chalk.bgBlue(`Result is: ${result}`));
    }
    else if (Input.operations === "Quit") {
        console.log(chalk.bgBlue("Thank you for using my Calculator."));
        quit();
    }
};
ClaCulator();
